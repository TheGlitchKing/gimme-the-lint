---
title: Upgrade Guide — v2.5.x to v2.7.0
tier: guide
domains:
  - procedures
status: active
...
- [`contract-guide.md`](../api/contract-guide.md) — what the entity contract is
- [`contract-rules-guide.md`](../standards/contract-rules-guide.md) — every rule, and the bug it stands on
- [`decision-vs-debt-guide.md`](../standards/decision-vs-debt-guide.md) — defect vs. debt, and the adoption cliff
