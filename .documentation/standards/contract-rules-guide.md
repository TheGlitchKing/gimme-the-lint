...
[`schema-lockfile-guide.md`](../api/schema-lockfile-guide.md).
...
> 📌 **Fact:** [`metadata` is reserved on every SQLAlchemy model](../knowledge-base/facts/metadata-is-reserved-on-sqlalchemy-models.md) — with a command that proves it.
...
> 📌 **Fact:** [A non-None default on an update schema overwrites stored data, and returns 200](../knowledge-base/facts/update-schema-defaults-overwrite-stored-data.md)
...
> 📌 **Fact:** [FastAPI emits an EMPTY response schema without `response_model`](../knowledge-base/facts/fastapi-omits-response-schema-without-response-model.md)
...
> 📌 **Fact:** [operationId derives from the function name, so renaming a handler is a breaking change](../knowledge-base/facts/fastapi-operation-ids-derive-from-function-names.md)
...
> 📌 **Fact:** [Hand-written client types drift by INVENTING fields](../knowledge-base/facts/hand-written-client-types-drift-by-inventing.md)
> · **Incident:** [A blank ZIP field for a release cycle](../knowledge-base/incidents/2026-07-06-blank-zip-field-and-invented-columns/narrative.md)
...
[`codegen-guide.md`](../api/codegen-guide.md).
