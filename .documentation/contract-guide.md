...
- [`contract-rules-guide.md`](contract-rules-guide.md) — every rule and its incident
- [`decision-vs-debt-guide.md`](decision-vs-debt-guide.md) — what can and cannot be baselined
- [`schema-lockfile-guide.md`](schema-lockfile-guide.md) — the API contract lockfile
- [`architecture-guide.md`](architecture-guide.md) — where the code lives and why
